...
<file path="gh25337/use_data.f90">
...
<file path="gh26920/two_mods_with_no_public_entities.f90">
module mod2
        implicit none
        private mod2_func1
    contains
...
<file path="gh26920/two_mods_with_one_public_routine.f90">
module mod2
        implicit none
        PUBLIC :: mod2_func1
    contains
...
<file path="module_data_docstring.f90">
module mod
  integer :: i
  integer :: x(4)
