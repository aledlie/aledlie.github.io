...
- `script_horizontal_direction(script_code, default) -> <ast.BinOp object at 0x1064b34d0>` - Line 210
- `script_horizontal_direction(script_code, default) -> HorizDirection` - Line 214
- `script_horizontal_direction(script_code, default) -> <ast.BinOp object at 0x1063460d0>` - Line 219
- `block(char)` - Line 232
