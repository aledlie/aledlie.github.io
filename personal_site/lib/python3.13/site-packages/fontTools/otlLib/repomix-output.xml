...
<file path="optimize/__init__.py">
...
<file path="optimize/__main__.py">
import sys
...
<file path="optimize/README_ENHANCED.md">
# optimize
...
<script type="application/ld+json">
{
  ...
  "name": "optimize",
  "description": "Directory containing 2 code files with 1 classes and 11 functions",
  "programmingLanguage": [
    {
...
- `compact_lookup(font, level, lookup) -> <ast.Constant object at 0x10635e710>` - Line 72
- `compact_ext_lookup(font, level, lookup) -> <ast.Constant object at 0x106d56cd0>` - Line 78
...
<script type="application/ld+json">
{
  ...
  "@type": "SoftwareSourceCode",
  "name": "otlLib",
  "description": "Directory containing 3 code files with 21 classes and 53 functions",
  "programmingLanguage": [
    {
      "@type": "ComputerLanguage",
      "name": "Python"
...
- `ChainContextualRule` (extends: <ast.Call object at 0x10612d510>) - Line 313
