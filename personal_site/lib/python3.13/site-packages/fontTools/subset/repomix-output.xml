...
<script type="application/ld+json">
{
  ...
  "name": "subset",
  "description": "Directory containing 4 code files with 9 classes and 172 functions",
  "programmingLanguage": [
    {
...
- `closure_element_ids(elements, element_ids) -> <ast.Constant object at 0x10637ff90>` - Line 90
...
- `update_glyph_href_links(svg, id_map) -> <ast.Constant object at 0x1064969d0>` - Line 167
