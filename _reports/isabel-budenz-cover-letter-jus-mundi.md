...
## Attachments
- Curriculum Vitae
- Writing Sample: [Arbitration-related research or analysis]
- Academic Transcript
...
## Alignment with Jus Mundi's Stated Requirements

From their job posting, Jus Mundi seeks candidates who:

| Requirement | How Isabel Demonstrates It |
|-------------|---------------------------|
| "Law students eager to understand international law and arbitration through the lens of information technology" | LLM in Arbitration + Integrity Studio AI experience + EU AI Act coursework |
| "Knowledge in commercial arbitration is required" | LLM specialization + A for Arbitration research experience |
| Understanding of legal tech | Integrity Studio experience + AI governance knowledge |

## Key Differentiators Highlighted

1. **A for Arbitration experience**: Direct relevance to Jus Mundi's core work
2. **Multilingual (4 languages)**: Expands their coverage capability
3. **AI implementation experience**: Understands practical AI deployment
4. **Regulatory knowledge**: EU AI Act expertise valuable for compliance

## Tone Calibration

- **Mission-aligned**: Emphasizes belief in democratizing access to arbitration intelligence
- **Specific**: Names Jus Mundi products and partnerships (DIAC)
- **Practical**: Focuses on concrete contributions, not just learning
- **Flexible**: Open to any office location
...
Add after the "Why Jus Mundi" section:
...
Add to arbitration credentials:
...
| **Duration** | 2-6 months |
| **Location** | Paris (HQ), also London, New York, Singapore |
| **Application** | [Welcome to the Jungle](https://www.welcometothejungle.com/en/companies/jus-mundi/jobs/internship-in-international-arbitration-based-in-paris-2-to-6-months_paris) |
| **Timeline** | Rolling applications |

---

*Cover letter prepared January 2026 for Jus Mundi International Arbitration Internship*
