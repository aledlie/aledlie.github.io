...
| Metric | Score | Notes |
|--------|-------|-------|
| Flesch Reading Ease | 10.4 | 0–30 very difficult, 60–70 standard, 90–100 very easy |
| Flesch-Kincaid Grade | 19.2 | US school grade level (Graduate+) |
| Gunning Fog Index | 22.8 | Years of formal education needed |
| SMOG Index | 19.5 | Grade level (requires 30+ sentences) |
| Coleman-Liau Index | 18.7 | Grade level via character counts |
| Automated Readability Index | 18.1 | Grade level via characters/words |
| Dale-Chall Score | 16.43 | <5 = 5th grade, >9 = college |
| Linsear Write | 14.8 | Grade level |
...
| Word count | 1,098 |
| Sentence count | 37 |
| Syllable count | 2,159 |
| Avg words per sentence | 29.7 |
| Avg syllables per word | 1.97 |
| Difficult words | 312 |
