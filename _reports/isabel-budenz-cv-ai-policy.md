...
**Contact**
isabelbudenz@hotmail.com | +31 (0)630639949 | Fuchsstraße
LinkedIn: [linkedin.com/in/isabel-budenz-005017240](https://www.linkedin.com/in/isabel-budenz-005017240/)
...
*[CUSTOMIZE: Add 2-3 relevant writing samples or projects]*
...
Convert this markdown to a clean, professional PDF with:
- **Font**: Clean sans-serif (Calibri, Arial, or similar)
- **Margins**: 0.75-1 inch
- **Length**: 2 pages maximum for most applications
- **Format**: Tables render as clean sections; remove markdown syntax

## Section Priority by Role Type

### For AI Company Policy Roles (Anthropic, OpenAI)
1. Professional Summary
2. Core Competencies (emphasize AI & Languages)
3. AI Policy Expertise
4. Professional Experience (Integrity Studio first)
5. Education

### For Think Tank/Research Roles (GovAI, IAPS, Institute for Law & AI)
1. Professional Summary
2. Education
3. Research & Policy Interests
4. AI Policy Expertise
5. Professional Experience
6. Selected Projects & Writing

### For Law Firm Tech Practice Roles
1. Professional Summary
2. Education
3. Professional Experience (legal experience first)
4. AI Policy Expertise
5. Core Competencies

### For Arbitral Institution Roles (ICC, LCIA)
1. Professional Summary
2. Education (LLM prominent)
3. Professional Experience (A for Arbitration first)
4. AI Policy Expertise (AI in Dispute Resolution section)
5. Languages
...
- [ ] Add Integrity Studio specific details (dates, location, bullet points)
- [ ] Add EU AI Act course institution name
- [ ] Add Clifford Chance internship date
- [ ] Add 2-3 writing samples/projects with descriptions
- [ ] Update professional affiliations (join relevant organizations)
- [ ] Add any conferences/events attended
- [ ] Complete certifications section (add any completed certs)

## Optional Enhancements

- [ ] Add LinkedIn URL (verify profile is updated)
- [ ] Add portfolio website if available
- [ ] Add GitHub if any relevant technical projects
- [ ] Add specific metrics where possible (e.g., "analyzed 50+ arbitral awards")

## Before Each Application

- [ ] Reorder sections per role type guidance above
- [ ] Tailor Professional Summary to specific role
- [ ] Emphasize most relevant experience for that employer
- [ ] Adjust AI Policy Expertise section to match job requirements
- [ ] Review for keywords from job description
...
**AI Policy & Governance Professional**
LLM International Commercial Arbitration candidate combining EU AI Act expertise, AI implementation experience, and multilingual research capability (German/Spanish native, English C2, French B1).
...
**EXPERIENCE**
- **Integrity Studio** | AI Consultant | [Dates]
  Advised mission-driven organizations on responsible AI implementation and governance frameworks

- **A for Arbitration** | Legal Researcher | 2019-2025
  Cross-jurisdictional legal research on international arbitration; policy monitoring; stakeholder communication

- **Clifford Chance** | Antitrust Virtual Intern | [Date]
  Regulatory compliance analysis in cross-border commercial contexts

**AI POLICY EXPERTISE**
EU AI Act (GPAI obligations, risk classification, enforcement) | NIST AI RMF | ISO 42001 | AI in Arbitration (AAA-ICDR, ICC Task Force) | Responsible AI Implementation

**LANGUAGES**
German (Native) | Spanish (Native) | English (C2) | French (B1)
