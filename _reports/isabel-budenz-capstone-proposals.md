...
5. **Assess "high-risk" AI classification** implications under EU AI Act for judicial/arbitral systems
6. **Propose harmonized standards** for AI governance in international arbitration
7. **Develop training materials** on AI arbitration for dispute resolution practitioners
...
**Intern Signature**: _________________________ **Date**: _____________
...
**Sponsor Signature**: _________________________ **Date**: _____________
...
5. **Assess federal preemption risks** for state AI laws and develop contingency guidance
6. **Evaluate standards alignment opportunities** (NIST AI RMF, ISO 42001, EU AI Act)
7. **Propose engagement strategy** for standards bodies and multi-stakeholder initiatives
...
| Framework | Issuer | Status |
|-----------|--------|--------|
| AI Risk Management Framework | NIST | Published; Generative AI Profile (July 2024) |
| ISO/IEC 42001 | ISO | Certifiable AI governance standard |
| AI Framework Convention | Council of Europe | First legally binding AI treaty (2024) |
| AI Ethics Recommendation | UNESCO | Global standard for 194 member states |
...
5. **Earn AI-related certifications** (Clio Legal AI Fundamentals, Coursera Prompt Engineering)
6. **Understand technical AI concepts** (NLP, LLMs, hallucinations, bias) at practitioner level
7. **Build portfolio of technical artifacts** demonstrating cross-disciplinary competence
